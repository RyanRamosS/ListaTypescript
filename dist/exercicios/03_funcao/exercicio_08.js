...
export function exercicio_08() {
    function desconto(preco_uni, quantidade) {
        if (quantidade > 10) {
            valor_desconto = 5;
    ...
    let preco_uni, quantidade, valor_desconto = 0, total_item = 0, produto, lista_Produto = [], i = 0, total = 0, saida = 0, precos = 0, media_preco = 0, precos_Quant = 0;
    while (saida != 2) {
