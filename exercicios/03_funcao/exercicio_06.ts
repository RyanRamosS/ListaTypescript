...
export function exercicio_06(): void {
    function imposto_Renda(salario_Bru: number): any {
    ...
    function total_Desconto (vale_A:number, vale_T:number, sind:number, inss:number, ir: number): any{
    ...
    function sal_Liquido (descontos:number, salario_Bru:number): any{
        return salario_liq = salario_Bru - descontos
    }

    let salario_Bru: number, descontos: number = 0, sind: number = 3.0, valor_ir:number = 0,
        vale_T: number = 6.0, vale_A: number = 8.0, inss: number = 1.0, valor_fgts:number,
        fgts: number = 11.0, salario_liq: number = 0, horas_trab: number, valor_hora: number = 0, ir: number = 0,
        valor_sind:number, valor_vale_A:number, valor_inss:number, valor_vale_T:number
