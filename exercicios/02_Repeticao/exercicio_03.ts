...
export function exercicio_03(): void{
    ...
    let nome: string = "", horas_Trabalhada: number = 0, salario_Hora: number = 0, sexo: number = 0, sexo_Feminino: number = 0,
        sexo_Masculino: number = 0, porcentagem_sexo_M: number = 0, porcentagem_sexo_F: number = 0, salario_total: number = 0,
        maior_salario: number = 0, nome_maior_salario: string = "", qtd_funcionario: number = 0, salario: number = 0, saida: number = 1
while(saida != 0){
